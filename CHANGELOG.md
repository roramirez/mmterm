...
- replace nested pixel-fill double-loops in `draw_tab_bar`, `draw_status_bar`, and `draw()` with `fill_rect` calls — eliminates 8 nested loop pairs, reducing cognitive and indentation complexity
